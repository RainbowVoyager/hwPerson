...
public class NewPerson {
    ...
    private static final String[] NAMES = {"Alex", "Ben", "Carl", "Mads", "Keanu", "Ryan", "Norman", "Sean Patrick"};
    private static final String[] LAST_NAMES = {"Alexov", "Benov", "Carlov", "Mikkelsen", "Keanu", "gosling", "Reedus", "Flanery"};
